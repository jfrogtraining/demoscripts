...
jfrog bt ent --access=r --keys=webinar-key2 create jfrog-int/bintray-webinar-gen
jfrog bt ent --access=r --keys=webinar-key2 create jfrog-int/bintray-webinar-test-reg
